...
from utils.analytics_cluster import run_kmeans, find_best_cluster, cluster_keywords, prepare_cluster_dataframe
...
def main():
    ...
    try:
        ...
        with tab1:
            ...
            # Plot
            df_cluster = prepare_cluster_dataframe(df, kmeans_model.labels_, X_svd)
            ...
            kw_df = cluster_keywords(kmeans_model, tfidf_vectorizer, n_words=10)
        ...
        with tab2:
            ...
            lda_topics_df = get_lda_topics(lda_model, cv, n_words=15)
